package com.putya.musicplayer.activities
...
import com.putya.musicplayer.networking.Api
...
class MusicDetailActivity : AppCompatActivity() {
    ...
    var modelListLagu: ModelListMusic? = null
    var progressDialog: ProgressDialog? = null
    var mHandler: Handler? = null
    var mRunnable: Runnable? = null
    var rotate: RotateAnimation? = null

    @SuppressLint("ObsoleteSdkInt", "Assert")
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        modelListLagu = intent.getSerializableExtra("detailLagu") as ModelListMusic
